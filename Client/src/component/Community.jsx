...
function Community() {
  ...
  return (
    <div className='bg-[#023E7D] pb-12 flex gap-x-[150px]'>
      ...
      <button className="px-4 py-2 bg-lime-600 rounded-md justify-center items-center gap-2.5 text-white text-sm font-medium font-['Montserrat'] leading-normal  mt-20" onClick={clickhandler}>LEARN MORE</button>
      </div>
      <div className=''>
