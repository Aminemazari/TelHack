  ...
  return (
    <div className='flex justify-between '>
      <div className=''>
        ...
        <button className="px-4 py-2 bg-lime-600 rounded-md justify-center items-center gap-2.5 text-white text-sm font-medium font-['Montserrat'] leading-normal ml-24 mt-20 "> Get Started</button>
      </div>
      <div className=''>
         <img src={StarUp} alt="" />
      </div>
